...
public class HmkNoticeController {
	...
	public JsonResult createRoomNotice(@RequestBody Map<String, Object> params) {
		try {
			boolean result = noticeService.createRoomNotice((Integer) params.get("roomMaker"),
	...
	public JsonResult createJoinNotice(@RequestBody Map<String, Object> params) {
		try {
			boolean result = noticeService.createJoinNotice((Integer) params.get("roomMaker"),
					(Integer) params.get("newUserNum"), (String) params.get("roomTitle"),
	...
	public JsonResult createStatusChangeNotice(@RequestBody Map<String, Object> params) {
		try {
			boolean result = noticeService.createStatusChangeNotice((Integer) params.get("roomNum"),
					(String) params.get("roomTitle"), (Integer) params.get("roomMaker"),
	...
	public JsonResult getNotices(@PathVariable int userNum, @RequestParam(required = false) String startDate,
		...
		try {
			...
			// 각 알림의 roomNum 확인
			for (HmkNoticeVo notice : notices) {
				System.out.println("Notice ID: " + notice.getNoticeNum() + ", Title: " + notice.getNoticeTitle()
						+ ", RoomNum: " + notice.getRoomNum());
			}
